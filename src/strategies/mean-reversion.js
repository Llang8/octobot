/*
 * TODO: Setup backtesting after market close (when current stock is sold)
 * to see if ANY stock would've performed better (from list) and switch
 */
class MeanReversion {
  constructor(alpaca, stock) {
